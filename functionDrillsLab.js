...
//CODE HERE
function thatsOdd(nums){
  if(nums % 2 === 0){
  return `That's not odd!`} else{
...
function emailChecker(email){
  email = String(email).trim()
    if(email.includes('@')){ return "Email Verified"
...
//CODE HERE
function frogWallet(coins){
  return coins / 3
}
let totalFrogs = frogWallet(27)
...
//CODE HERE
function frogWallet2(coins){
  return coins / 4
}
let totalFrogs = frogWallet2(4)
console.log(totalFrogs)
